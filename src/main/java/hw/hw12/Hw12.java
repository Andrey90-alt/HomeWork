...
public class Hw12 {
    public  void readFile(String filename) {
        try {
            File myFile = new File("C:\\Users\\Андрей\\IdeaProjects\\HomeWork\\src\\main\\java\\hw\\hw12\\files\\"+filename);
    ...
    public  void createFile(String filename) {
        File myObj = new File("C:\\Users\\Андрей\\IdeaProjects\\HomeWork\\src\\main\\java\\hw\\hw12\\files\\"+filename);
        try {
    ...
    public static void main(String[] args){
        ...
        Scanner in = new Scanner(System.in);
        try {
            File f = new File("C:\\Users\\Андрей\\IdeaProjects\\HomeWork\\src\\main\\java\\hw\\hw12\\files");
